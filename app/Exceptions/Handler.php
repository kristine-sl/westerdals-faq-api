...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $exception)
    {
        ...
        if ($exception instanceof ApiException) {
            ...
            return $this->renderConsoleResponse($exception);
        }
     ...
     * @return void
     */
    protected function renderConsoleResponse(Exception $exception)
    {
        $this->renderForConsole(new ConsoleOutput(ConsoleOutput::VERBOSITY_VERBOSE), $exception);
    }
